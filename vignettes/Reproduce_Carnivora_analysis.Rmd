...
This vignette aims to explain the methodology applied to obtain the morphological alignment with the Carnivora data set used as an input for MCMCtree v4.9i. This approach can be divided in 5 steps:  
  ...
  3. Obtain morphological alignment, `M`  
  4. Correct `M` for population noise and character correlation  
...
| Taxon^{(\mathrm{a})}                          | Voucher specimen | Specimen age (mid-point age^{(\mathrm{b})}), Ma | Reference^{(\mathrm{c})}                                                                     |
|-----------------------------------------------|------------------|-------------------------------------------------|----------------------------------------------------------------------------------------------|
| Hesperocyon sp. ???                             | NMNH 459576      | 35.5500 (37.2000\text{-}33.9000)                | National Museum of Natural History collection                                                |
| Enhydrocyon pahinsintewakpa ???                 | AMNH 27579       | 28.5500 (30.800\text{-}26.3000)                 | Wang 1994, pp. 89-90                                                                         |
| Paraenhydrocyon josephi ???                     | YPM 12702        | 25.6150 (30.8000\text{-}20.4300)                | Wang 1994, p. 135 & p. 141                                                                   |
| Tomarctus hippophaga ???                        | AMNH 61156       | 14.7850 (15.9700\text{-}13.6000)                | Wang et al. 1999, pp. 157-158                                                                |
| Aelurodon ferox ???                             | AMNH 61757       | 13.1350 (15.9700\text{-}10.3000)                | Wang et al. 1999, pp. 182-183                                                                |
| Epicyon haydeni ???                             | LACM 131855      | 11.9500 (13.6000\text{-}10.3000)                | Wang et al. 1999, pp. 252-254                                                                |
| Smilodon fatalis ???                            | LACMHC 1360      | 0.0285 (0.0440\text{-}0.0130)                   | La Brea Tar Pits collection                                                                  |
| Hyaenictitherium wongii ???                     | China G L-49     | 6.6500 (8.0000\text{-}5.3000)                   | Werdelin 1988, p. 259; Werdelin & Solounias 1991, p. 33; Tseng & Wang 2007, p. 708 (Table 2) |
| Canis dirus ???                                 | LACMHC 2300-4    | 0.0285 (0.0440\text{-}0.0130)                   | La Brea Tar Pits collection                                                                  |
...
```
  ...
  * It has 19 rows, one for each of the 19 specimens, and 89 columns, 2 columns with information about the specimens and 87 columns with the 3D coordinates collected for each landmarks, i.e. $29x3 = 87$ morphological traits.  
...
## 3. Obtain morphological alignments  
