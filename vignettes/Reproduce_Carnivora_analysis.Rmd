...
The reconstruction is stored as a matrix object. We can convert it to an array for compatibility with morphometrics software. This also allows 3D plots using the rgl package.
