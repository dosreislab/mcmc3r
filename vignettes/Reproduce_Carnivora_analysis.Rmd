...
```
  ...
  * It has 19 rows, one for each of the 19 specimens, and 89 columns, 2 columns with information about the specimens and 87 columns with the 3D coordinates collected for each landmarks, i.e. $29 x 3=87$ morphological traits.  
