...
vulpes21x29 <- morpho::matrix2array( X = vulpes21x29.raw.matrix, coords = 3 )

# Run geomorph::gpagen and save coordinates in an array
...
vulpes21x29.matrix <- morpho::array2matrix( X = vulpes21x29.array, coords = 3 )
devtools::use_data( vulpes21x29.matrix )
