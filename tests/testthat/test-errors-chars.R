...
test_that(
	...
	{
	expect_error(
	  morpho::sim.morpho( tree = sim.tree, n = 100.56, c = 0.25 )
	)
	}
)
...
test_that(
  ...
  {
    expect_error(
      morpho::sim.pop( psample = 20, n = 100.56, c = 0.25 )
    )
  }
)
...
test_that(
  ...
  {
    expect_error(
      morpho::sim.pop( psample = 20, n = -45, c = 0.25 )
    )
  }
)
...
test_that(
  ...
  {
    expect_error(
      morpho::sim.pop( psample = 20, n = 0, c = 0.25 )
    )
  }
)
