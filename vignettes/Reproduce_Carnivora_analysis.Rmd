...
File `mcmc.txt`, which contains the raw MCMC output, can be loaded into R. Use the `setwd` function in R to set your working directory to `carnivores/`. Then, from within R
...
mcmc3r::mcmc2densitree(tt, mcmc, "t_", 0.025, alpha=0.1, tip.ages=back.ages, cex=.8)
